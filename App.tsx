...
import { 
  getFirestore, 
  collection, 
  onSnapshot, import React, { useState, useEffect } from 'react';
import { HashRouter as Router, Routes, Route, Navigate } from 'react-router-dom';
import { initializeApp } from "firebase/app";
import { 
  getAuth, 
...
const AppContent: React.FC = () => {
  ...
  // ✅ NOVA FUNÇÃO: Carrega staff sem listener
          ...
          !user ? <Login company={company} /> : (
            <Layout user={user} onLogout={() => signOut(auth)} onUpdateUser={handleUpdateUser}>
              <Routes>
                ...
                {/* ✅ CORRIGIDO: Rota de Staff sem filtro e com manipulação correta de exclusão */}
